<%@ page language="VB" autoeventwireup="false" inherits="Empresa, App_Web_aofv2bk4" masterpagefile="Site.master" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="idEmpresa" ForeColor="#333333" GridLines="None" Width="543px">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="idEmpresa" HeaderText="id" />
                        <asp:TemplateField HeaderText="Empresa">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("nEmpresa") %>'></asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("nEmpresa") %>'></asp:Label>
