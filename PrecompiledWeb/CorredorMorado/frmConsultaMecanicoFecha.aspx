<%@ page language="VB" autoeventwireup="false" inherits="frmConsultaMecanicoFecha, App_Web_aofv2bk4" masterpagefile="Site.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
           <h3>Consulta por Mecanico</h3>
    <table >
    <tr>
  
        <td class="auto-style7"  >       
       
            <asp:DropDownList ID="ddlMecanico" runat="server" DataSourceID="lnqMecanico" DataTextField="nPersona" DataValueField="nPersona">
            </asp:DropDownList>
               <asp:LinqDataSource ID="lnqMecanico" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" OrderBy="idPersona" Select="new (nPersona)" TableName="Personal">
            </asp:LinqDataSource>
            
        </td>
        <td class="auto-style8">
       
            <asp:TextBox ID="Fecha1" runat="server" Width="132px" TextMode="Date"></asp:TextBox>
          
            <asp:TextBox ID="Fecha2" runat="server" Width="132px" TextMode="Date"></asp:TextBox>
    ...
    <tr>
        <td colspan="5">
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="idDetalleMant" CssClass="table table-hover table-striped" AllowSorting="True" EnableTheming="True" PageSize="50">
                <Columns>
