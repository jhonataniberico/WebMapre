<%@ page language="VB" autoeventwireup="true" inherits="frmIngreso, App_Web_o1ayshfk" masterpagefile="Site.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="lblFecha0" runat="server" CssClass="text-center" Text="Fecha"></asp:Label>   <asp:TextBox ID="txtConsFecha" runat="server" CssClass="text-center" AutoPostBack="True" TextMode="Date"></asp:TextBox>
   
               </h4>
               <h4 style="text-align:center">
                   Ordenes Trabajo Sin Registrar</h4>
     ...
     <h4 style="text-align:center">REGISTRO DE MANTTOS EJECUTADOS&nbsp;
          ...
          <table class="table table" border="0" draggable="false" style="width: 649px">
                   <tr><th  colspan="3" class="auto-style21">OT:&nbsp;&nbsp;
               ...
               <tr>
                 ...
                 <td class="auto-style14">Est:
                  ...
                  <tr><th id="Encabezado2"  colspan="3" class="auto-style22">REGISTRO DE MANTENIMIENTOS</th></tr>
              <tr>
                ...
                <SortedAscendingCellStyle BorderStyle="Outset" BackColor="#FDF5AC" />
                   ...
                   <SortedDescendingHeaderStyle BackColor="#820000" />
                            ...
                            <asp:textbox ID="txtobsBitacora" runat="server" Height="59px" TextMode="MultiLine" Width="160px"></asp:textbox>
                                                         <br />
                             Tecnico:&nbsp;<asp:DropDownList ID="cboPersonalBitacora" runat="server" Width="138px" Height="31px">
                            </asp:DropDownList>
                                            &nbsp;<asp:ImageButton ID="ibGuardarBitacora" ValidationGroup="IngresoProveedor" runat="server" ImageUrl="~/Images/add24.png"/>
                                                 &nbsp;</td>  </tr>
                  <tr><th id="Encabezado1" colspan="3" class="auto-style8">VALIDAR TERMINO DE REGISTRO&nbsp;&nbsp; <asp:ImageButton ID="ibValidadorYCIERREOPERATIVO" ValidationGroup="IngresoProveedor" runat="server" ImageUrl="~/Images/CHECK_NEGRO2.png"/>
                                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th></tr>
