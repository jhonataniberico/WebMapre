<%@ page language="VB" autoeventwireup="false" inherits="frmAnexoRegulacion, App_Web_k5hroeaa" masterpagefile="~/Site.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">

    </asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Anexo Regulacion</h3>
      <div class="span4">
     <p>
        <asp:Label ID="Label3" runat="server" Text="Unidad"></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" CssClass="form-control" Font-Size="Larger" Width="166px" Height="47px">
        </asp:DropDownList>
    </p>
   </div>
      ...
      <div class="span8">
            ...
            <asp:GridView 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Marca" HeaderText="Referencia" />
                    <asp:BoundField DataField="Fecha" HeaderText="Fecha" ReadOnly="True" />
                    <asp:BoundField DataField="KmIntervencion" HeaderText="Km Intervencion" />
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="ImageButton2" runat="server" CommandName="Select" ImageUrl="~/Images/details.png" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
