<%@ page language="VB" autoeventwireup="false" inherits="frmAcMotor, App_Web_aofv2bk4" masterpagefile="~/Site.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Aceite Motor</h3>
    <div class="span4">
    <p><asp:Label ID="Label3" runat="server" Text="Unidad"></asp:Label>
    ...
    <asp:ImageButton ID="ImageButton1" runat="server" Height="48px" ImageUrl="~/Images/excel.png" Width="48px" />--%>
      ...
      <asp:GridView 
         ...
         <asp:DetailsView ID="DetailsView1"
                     runat="server" 
                     Height="16px" CellPadding="4" ForeColor="#333333" AutoGenerateRows="False" CssClass="table table-hover table-striped" Width="272px">
...
<asp:BoundField DataField="CodOT" HeaderText="CodOT"></asp:BoundField>
               ...
               <asp:BoundField DataField="tecnicoApoyo" HeaderText="Técnico de Apoyo" Visible="False" />
