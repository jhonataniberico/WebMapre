<%@ page language="VB" autoeventwireup="false" inherits="frmRepMotor, App_Web_5jd5nx0l" masterpagefile="~/Site.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">

    </asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Reparacion de Motor</h3>
        <div class="span4">
    <p>
    ...
    </p><asp:ImageButton ID="ImageButton1" runat="server" Height="48px" ImageUrl="~/Images/excel.png" Width="48px" />
   </div>
    <div class="span8">
               <asp:GridView 
                ID="GridView3" 
