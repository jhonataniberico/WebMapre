<%@ page language="VB" autoeventwireup="false" enableeventvalidation="false" inherits="frmUnidad, App_Web_o1ayshfk" masterpagefile="Site.master" %>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#a90329', endColorstr='#6d0019',GradientType=0 ); background-color: #660066; color: #FFFFFF;">

           MAESTRO DE SERVICIOS</div>
    <div class="span12">
        <div class="span1"></div>
        <div class="span10">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ValidationGroup="IngresoProveedor" ControlToValidate="TxTcodigo" ErrorMessage="Campo Requerido" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <br />
                            <br />
            ...
            <asp:DropDownList ID="ddlSistema" runat="server" AutoPostBack="True">
                ...
                <tr>
                    ...
                    &nbsp;</td>
                    <td>
                        <asp:ImageButton ID="ibAGREAGAR" runat="server" ImageUrl="~/Images/add24.png" Height="24px" Width="24px"/>
